...
function html5orjavamenu()
{
   ...
   if (sup_firefox && sup_socket && sup_webaudio) s+='<input type="button" value="Firefox audio start" onclick="chrome_audio_start()" style="background:#88ff88; font-weight: bold">';
